// Generated by SolidPython 1.1.3 on 2025-05-08 22:01:50
// Dholydai: 13 May 2025 20mm sidewall
// 22May 2025 angle cuts
...
//Reset and Run Holes
     #translate([280.2,74.6,14.5])
         cylinder(d=4,h=6);
     #translate([280.2,65.8,14.5])
         cylinder(d=4,h=6);
//Screw Holes Side
#translate([311.8,35,6]){
union(){
rotate([0,-90,0]){
     translate([0,0,1.6])
         cylinder(d=3.2,h=6);      
...
//USB Port
translate([305,63.425,0])
    cube([10,13.5,11.6]);
    
//Trim Rgt Shift key slot
#translate([280,44.335,15])
    cube([22,12.37,7]);
    
//EOS: Fore=241.625 Aft=232.1
    
//Shallow angle sidewall cuts
//Cutter Fore (left end)
#translate ([236.765,-1,0])
//                  0        1        2        3        4        5         6         7
...
//USB Port (Inside Union) Right!!!
//Top Wedge
#translate([308.8,63.425,9.6])
//                    0           1        2        3           4           5         6           7
    polyhedron(points=[[3,0,2], [3,13.5,2], [1,13.5,0], [1,0,0], [0,0,2], [0,13.5,2], [0,13.5,0], [0,0,0]],
    faces=[[0,1,2,3],[5,4,7,6],[0,4,5,1],[0,3,7,4],[5,6,2,1],[7,3,2,6]]);

//Left Wedge
#translate([308.8,63.425,3.5])
//                      0           1        2        3           4           5         6           7
    polyhedron(points=[[1,2,2], [3,0,0], [0,0,0], [1,2,8.25], [3,0,8.25], [0,0,8.25], [0,2,8.25], [0,2,2]],
        faces=[[0,1,4,3],[7,6,5,2],[2,5,4,1],[0,7,2,1],[3,4,5,6], [7,0,3,6]]);
        
//Right Wedge
#translate([308.8,74.925,3.5])
//                      0           1        2        3           4           5         6           7
    polyhedron(points=[[1,0,2], [0,2,0], [3,2,0], [1,0,8.25], [0,2,8.25], [3,2,8.25], [0,0,8.25], [0,0,2]],
        faces=[[7,1,4,6],[0,3,5,2],[2,5,4,1],[0,2,1,7],[3,6,4,5],[7,6,3,0]]);   
}              

//Controller PCB Notches
#translate([307.4875,60.676,5])
    polyhedron(points=[[2,0,1], [2,19,1], [0,19,0], [0,0,0], [2,0,3], [2,19,3], [0,19,3], [0,0,3]], 
    faces=[[0,4,5,1],[0,3,7,4],[1,5,6,2],[2,6,7,3],[0,1,2,3],[4,7,6,5]]); 
}  
//Measure X=311.8 Y=140.35
//Measure Ends of Section
*translate([241.625,-2,16])
    cube(4);
*translate([232.1,138.43,16])
    cube(4);
//EOS: Fore=241.625 Aft=232.1
/***********************************************
*********      SolidPython code:      **********
