				...
				translate(v = [3.5000000000, 0, 0]) {
					difference() {
						...
						union() {
							...
							translate(v = [0, 0, -40.0000000000]) {
								translate(v = [-184.1506350000, 0, 0]) {
...
translate([176.65,25.06,18.89])
    cube([15.7,14.1,1.11]);
//Slot Patch
translate([141.2,29.6,18.89])
    cube([86.55,5,1.11]);

}
//Screw Holes B
//Fore
#translate([142.325,0,6]){
union(){
rotate([-90,0,0]){
     translate([0,0,1.6])
         cylinder(d=3.2,h=6);      
...
//EOS Lft: Fore=127.325 Aft=117.8
//Shallow angle sidewall cuts
//Cutter Fore (left end)
#translate ([122.465,-1,0])
//                  0        1        2        3        4        5         6         7
polyhedron(points=[[0,0,0], [5,0,0], [5,5,0], [0,5,0], [0,0,19], [4.85,0,19], [4.85,5,19], [0,5,19]],
 ...
 //Cutter Aft (left end)            
#translate ([112.94,135.35,0])
//                  0        1        2        3        4        5         6         7
polyhedron(points=[[0,0,0], [5,0,0], [5,5,0], [0,5,0], [0,0,19], [4.85,0,19], [4.85,5,19], [0,5,19]],
 
    faces=[[0,4,5,1],[0,3,7,4],[1,5,6,2],[2,6,7,3],[0,1,2,3],[4,7,6,5]]
              );
//EOS Rgt: Fore =241.625 Aft=232.1             
//Cutter Fore (right end)
#translate ([241.475,-1,0])
//                  0        1        2        3        4        5         6         7
...
//Left
*translate([123.325,-1,15])
cube(4);
*translate([113.8,137.35,15])
cube(4);
//Right
*translate([241.625,-1,16])
cube(4);
*translate([232.1,136.35,16])
cube(4);
//EOS Lft: Fore=127.325 Aft=117.8
//EOS Rgt: Fore =241.625 Aft=232.1
/***********************************************
