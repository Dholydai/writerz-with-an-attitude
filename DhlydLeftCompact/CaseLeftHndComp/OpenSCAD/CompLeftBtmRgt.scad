...
#translate([52.275,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);
    }
}     
#translate([82.275,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);      
      }
    }
...
//PCB Bottom Edge Support
 translate([40,112.65,2])
    cube([9,6,8]);
#translate([40,115.65,10])
    cube([9,3,2]);
translate([80,112.65,2])
    cube([13,6,8]);
#translate([80,115.65,10])
    cube([13,3,2]);
translate([123,112.65,2])
    cube([13,6,8]);
#translate([123,115.65,10])
    cube([13,3,2]);
