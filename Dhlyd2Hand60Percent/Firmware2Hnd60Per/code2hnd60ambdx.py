...
keyboard.keymap = [
    ...
    [KC.ESC, KC.GRV, KC.N1, KC.N2, KC.N3, KC.N4, KC.N5, KC.N6, KC.N7, KC.N8,
     ...
     KC.LCTL, LFN, KC.LGUI, KC.LALT, KC.NO, KC.NO, KC.SPC, KC.NO, KC.NO, KC.RALT,
     KC.LGUI, RFN, KC.NO, KC.RCTL,
     ],

    # Function Right 1
    [KC.TRNS, KC.TRNS, KC.F1, KC.F2, KC.F3, KC.F4, KC.F5, KC.F6, KC.F7, KC.F8,
     KC.F9, KC.F10, KC.F11, KC.F12,
     KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.PSCR,
     KC.SLCK, KC.PAUS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,
     KC.DEL, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.INS,
     KC.HOME, KC.PGUP, KC.TRNS, KC.TRNS, KC.NO, KC.TRNS,
     KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.DEL,
     KC.END, KC.PGDN, KC.TRNS, KC.UP, KC.NO, KC.TRNS,
     KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.NO, KC.NO, KC.TRNS, KC.NO, KC.NO,
     KC.TRNS, KC.LEFT, KC.DOWN, KC.NO, KC.RIGHT,
     ],
