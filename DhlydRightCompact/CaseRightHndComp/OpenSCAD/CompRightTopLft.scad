// Generated by SolidPython 1.1.3 on 2025-05-08 22:03:39
// Dholydai: 13 May 2025 20mm sidewall angle cuts
...
//Reset and Run Holes
     #translate([31.6,74.6,14.5])
         cylinder(d=4,h=6);
     #translate([31.6,65.8,14.5])
         cylinder(d=4,h=6);
//Screw Holes Side
#translate([0,35,6]){
union(){
...
//EOS: Fore=89.225 Aft=98.75
//Screw Hole Fore
#translate([55.175,0,6]){
union(){
rotate([-90,0,0]){
     translate([0,0,1.6])
         cylinder(d=3.2,h=6);      
...
//Trim Lft Shift key slot
#translate([11.6,44.335,15])
    cube([22,12.37,7]);
}
...
*translate([70.175,-1,16])
cube(4);
*translate([79.7,134,16])
cube(4);
/***********************************************
*********      SolidPython code:      **********
************************************************
