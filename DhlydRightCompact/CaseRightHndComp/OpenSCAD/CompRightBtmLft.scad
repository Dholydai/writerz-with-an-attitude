...
//Screw Holes Fore
#translate([52.275,-1,6]){
    rotate([-90,0,0]){
         cylinder(d=2.8,h=12);      
      }
}
#translate([82.275,-1,6]){
    rotate([-90,0,0]){
         cylinder(d=2.8,h=12);      
      }
}
//Screw Holes Aft
#translate([61.8,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);
    }
}     
#translate([91.8,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);      
      }
    }
...
translate([38,15.7,2])
    cube([9,6,8]);
translate([38,15.7,10])
    cube([9,3,2]);
translate([80,15.7,2])
    cube([13,6,8]);
translate([80,15.7,10])
    cube([13,3,2]);
