				...
				translate(v = [3.5000000000, 0, 0]) {
					difference() {
						...
						union() {
							...
							translate(v = [0, 0, -40.0000000000]) {
								translate(v = [-234.8865000000, 0, 0]) {
...
translate([119.5,25.05,18.89])
    cube([15.7,14.1,1.11]);
//Slot Patch
translate([84.05,29.6,18.89])
    cube([86.55,5,1.11]);
}
//Screw Holes B
//Fore
#translate([85.175,0,6]){
union(){
rotate([-90,0,0]){
     translate([0,0,1.6])
         cylinder(d=3.2,h=6);      
...
cube(4);
//Left
*translate([184.475,-1,16])
cube(4);
*translate([194,134,16])
cube(4);
/***********************************************
*********      SolidPython code:      **********
************************************************
