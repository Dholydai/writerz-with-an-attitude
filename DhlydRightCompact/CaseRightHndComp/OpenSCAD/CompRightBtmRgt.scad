...
#translate([109.425,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);
    }
}     
#translate([139.425,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);      
      }
    }
...
translate([77.5,112.65,2])
    cube([8,6,8]);
translate([77.5,115.65,10])
    cube([8,3,2]);
translate([119,112.65,2])
    cube([10,6,8]);
translate([119,115.65,10])
    cube([10,3,2]);
//Measure U1 Gap
*translate([-4,58,4])
cube(4);
