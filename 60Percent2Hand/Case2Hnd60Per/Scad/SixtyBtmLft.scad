...
//Dimensions Top Case
//X-Front=89.225 X-Back=108.25 Y=102.25 
//Screw Holes Fore
...
//Screw Holes Aft
#translate([90.375,98,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);
    }
}     
#translate([120.375,98,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);      
    }
}
//Sidewall Notch for Stabilizer
translate([95.85,2.75,7.2])
