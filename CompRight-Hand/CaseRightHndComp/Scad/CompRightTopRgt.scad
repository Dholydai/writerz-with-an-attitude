...
//Trim Enter key slot
#translate([257,63.385,15])
    cube([22,12.37,7]);
//Trim Rgt Shift key slot
#translate([255,82.435,15])
    cube([22,12.37,7]);
//Trim Backspace key slot
#translate([260,101.485,15])
    cube([22,12.37,7]);
    
//Shallow angle sidewall cuts
//Cutter Fore (left end)
#translate ([179.615,-1,0])
//                  0        1        2        3        4        5         6         7
