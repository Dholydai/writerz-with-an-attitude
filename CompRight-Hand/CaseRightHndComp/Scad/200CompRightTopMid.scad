// Generated by SolidPython 1.1.3 on 2024-12-29 17:41:44
// Modified by Dholydai on 05 January 2024
$fn = 32;
...
//Stagger Patch
translate([119.5,25.05,17.89])
    cube([9.8,14.1,1.11]);
//Slot Patches
translate([84.05,29.6,17.89])
    cube([36.4,5,1.11]);
translate([144.675,29.6,17.89])
    cube([25.75,5,1.11]);
