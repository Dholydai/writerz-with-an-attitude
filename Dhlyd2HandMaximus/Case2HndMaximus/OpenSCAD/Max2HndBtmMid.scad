...
// Add 0.6mm to the section's X axis, distributed 0.3mm to each side (no movement of the screw holders), compensating for shrinkage (x=143.8)
...
// Change USB port wedge to truncated,reduced ribs Z 10 Jul 2026
...
//                      0           1           2           3       4       5            6          7
polyhedron(points=[[0,0,0], [13.3,0,0], [13.3,3,0], [0,3,0], [2,0,2], [11.3,0,2], [11.3,1,2],[2,1,2]],
    faces=[[0,1,2,3],[6,7,3,2],[0,4,5,1],[0,3,7,4],[5,6,2,1],[7,6,5,4]]
              );       
