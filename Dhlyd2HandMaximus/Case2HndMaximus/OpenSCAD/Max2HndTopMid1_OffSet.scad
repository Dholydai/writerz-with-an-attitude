// Generated by SolidPython 1.1.3 on 2025-05-02 22:15:16
...
// Add cut to remove the stabilizer dingleberries.
// Add patches to cover the spacebar slots.
// Offset the spacebar switch hole.

$fn = 32;

// Check Version Change
*translate([100,45.65,16])
    cube(4);
				...
				translate(v = [3.5000000000, 0, 0]) {
					difference() {
						...
						union() {
							...
							translate(v = [0, 0, -40.0000000000]) {
								translate(v = [-336.6135000000, 0, 0]) {
							...
							translate(v = [0, 0, -40.0000000000]) {
								translate(v = [-333.3750000000, 0, 0]) {
							...
							translate(v = [0, 0, -40.0000000000]) {
								translate(v = [-330.1365000000, 0, 0]) {
...
//Centered Switch Patch
#translate([138.55,14.05,18.89])
    cube([15.7,14.1,1.11]);
//Slot Patch
#translate([103.1,18.6,18.89])
    cube([86.55,5,1.11]);
}    

//Screw Holes B
//Fore
#translate([104.225,0,6]){
union(){
rotate([-90,0,0]){
     translate([0,0,1.6])
         cylinder(d=3.2,h=6);      
...
//Place SP
#translate([148.89,14.05,10])
// Switch Plug
union() {
#translate([0,0,0])
    cube(14.02);
//Far X columns
#translate([14.02,1.08,0])
    cube([0.8,3.115,14.02]);
#translate([14.02,9.87,0])
    cube([0.8,3.115,14.02]);
//Near X columns
#translate([-0.8,1.08,0])
    cube([0.8,3.115,14.02]);
#translate([-0.8,9.87,0])
    cube([0.8,3.115,14.02]);
    }  
}
    
// Left End of Case Section
*translate([89.225,-2,0])
    cube(4);
*translate([98.75,140.35,0])
    cube(4);
// Right End of Case Section
*translate([203.525,-2,0])
    cube(4);
*translate([208.2875,140.35,0])
    cube(4);
/***********************************************
*********      SolidPython code:      **********
************************************************
