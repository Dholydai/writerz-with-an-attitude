...
//EOS: Top Case
//X-Front=127.32 X-Back=117.8 

//Screw Holes Fore
#translate([109.32,-1,6]){
    rotate([-90,0,0]){
         cylinder(d=2.8,h=12);      
      }
}
#translate([139.32,-1,6]){
    rotate([-90,0,0]){
         cylinder(d=2.8,h=12);      
      }
}
//Screw Holes Aft
#translate([99.8,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);
    }
}     
#translate([129.8,135.35,6]){
    rotate([90,0,0]){
         cylinder(d=2.8,h=12);      
      }
    }
...
#translate([75.5,13,9])
    cube([8,3,2]);
translate([116.5,13,2])
    cube([11,6,7]);
#translate([116.5,13,9])
    cube([11,3,2]);
//Measure U1 Gap
*translate([-4,58,4])
cube(4);
