...
// Modified by Dholydai on 03 January 2024
$fn = 32;
...
//Stagger Patch
translate([138.55,25.09,17.89])
    cube([9.8,14.1,1.11]);
//Slot Patches
translate([103.1,29.6,17.89])
    cube([36.4,5,1.11]);
translate([163.725,29.6,17.89])
    cube([25.75,5,1.11]);
